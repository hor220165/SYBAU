  ...
  Future<void> _handleSubmit() async {
    ...
    try {
      if (_authState == AuthState.login) {
        ...
        await ApiService.login(email, password); // auto-login after register
      }
          ...
          child: Column(
            children: [
              ...
              Align(
                ...
                // Removed the top-left back button so user naturally uses the bottom one.
